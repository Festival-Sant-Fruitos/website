        ...
        <Container>
          <div className="max-w-[60rem]">
              ...
              <div className="flex items-center gap-[2rem] mt-[3.2rem]">
                <span className="text-[1.4rem] text-[var(--color-text-light)] font-medium tracking-wide uppercase">
                  Segueix-nos
                </span>
                <div className="flex items-center gap-[1.2rem]">
                  <a
                    ...
                    aria-label="Facebook"
                    className="w-[4rem] h-[4rem] flex items-center justify-center border border-[var(--color-border)] text-[var(--color-text-muted)] hover:text-[var(--color-secondary)] hover:border-[var(--color-secondary)] transition-colors"
                  >
