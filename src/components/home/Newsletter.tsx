      ...
      <Container>
        <div className="max-w-[600px]">
          <BlurFade inView inViewMargin="-80px">
            ...
            <h2 className="text-2xl md:text-[3rem] font-serif font-light text-white leading-[1.1] mb-4">
          ...
          <BlurFade inView inViewMargin="-60px" delay={0.25}>
            <div className="flex items-center gap-5 mt-10">
              <span className="text-[13px] text-white/30 font-medium tracking-[0.15em] uppercase">
                Segueix-nos
              </span>
